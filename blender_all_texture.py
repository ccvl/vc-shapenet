...
for param in view_params:
    ...
    for i in range(len(texture_util.texture_bank)):
        [apply_texture(mesh, i) for mesh in meshes]
        syn_image_file = './%s_%s_%d_a%03d_e%03d_t%03d_d%03d.jpg' % (shape_synset, shape_md5, i,round(azimuth_deg), round(elevation_deg), round(theta_deg), round(rho))
